...
<div id="editForm">
 ...
 <div>
  ...
  async startCodeMirrorEditor() {
    this.fileParser = newtondbParser // replaced at server time.
    this.codeMirrorInstance = new GrammarCodeMirrorMode("custom", () => newtondbParser, undefined, CodeMirror).register().fromTextAreaWithAutocomplete(document.getElementById("fileContent"), {
      lineWrapping: false,
      lineNumbers: true
    })
